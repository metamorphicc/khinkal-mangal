      ...
      <div className="mx-auto flex min-h-[calc(100vh-12rem)] max-w-7xl flex-col justify-center">
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
          ...
          <div>
            ...
            <p className="mt-6 max-w-3xl text-lg font-bold leading-8">
        ...
        <div className="mt-14 grid gap-4 lg:grid-cols-3">
          {siteConfig.reviews.items.map((review) => (
            <article
              key={review.name}
              className="flex min-h-80 flex-col justify-between border border-[var(--line)] p-6"
            >
              <div>
                <Quote className="text-terracotta" size={30} />
